...
namespace Agenda_Telefonica.Controllers
{
    ...
    {
        private readonly Agenda_TelefonicaContext _context;

        public ContatosController(Agenda_TelefonicaContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Endereco,Telefone")] Contatos contatos)
        {
            if (id != contatos.Id)
            {
                return NotFound();
